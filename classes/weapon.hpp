...
public:
    short get_def_id(void) {
        return *reinterpret_cast<short *>(this + 0xc30 + 0x90 + 0x44);
    }
    ...
    float get_charged_damage(void) {
        return *reinterpret_cast<float *>(this + 0x109C);
    }

    float get_last_attack(void) {
        return *reinterpret_cast<float *>(this + 0x1064);
    }

    float get_next_primary_attack(void) {
        return *reinterpret_cast<float *>(this + 0xE94);
    }

    float get_next_secondary_attack(void) {
        return *reinterpret_cast<float *>(this + 0xE98);
    }
